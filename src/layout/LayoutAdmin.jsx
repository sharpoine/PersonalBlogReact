...
const LayoutAdmin = () => {
    ...
    return (
        <div className='w-full min-h-screen font-anton font-normal flex flex-1 justify-start'>
            <div className='left-menu w-[350px] flex items-center flex-col pt-[70px] pl-[15px] pr-[20px] gap-4'>
                ...
                dark:shadow-blue-800/80 font-medium rounded-lg text-lg px-5 py-2.5 text-center me-2 mb-2 "

                >
                    Post Oluştur</Link>
                <Link to="/admin/create-category" class="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 
                ...
                font-medium rounded-lg text-lg px-5 py-2.5 text-center me-2 mb-2">Kategori Oluştur</Link>
            ...
            <div className='lg:py-[70px] lg:px-[30px] py-[20px] px-0 mx-auto  h-full w-full'>
